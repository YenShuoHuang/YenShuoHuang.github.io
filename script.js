...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function initModelViewer() {
        ...
        // Dynamically load the model-viewer library if not already registered
        if (!customElements.get('model-viewer')) {
            const script = document.createElement('script');
            script.type  = 'module';
            script.src   = 'https://unpkg.com/@google/model-viewer/dist/model-viewer.min.js';
            script.onload  = createViewer;
            script.onerror = () => showError('Failed to load 3D viewer library. Check your internet connection.');
    ...
    function createViewer() {
        ...
        container.innerHTML = `
            <model-viewer
                ...
                <div slot="poster" style="
                    ...
                    height:100%;flex-direction:column;padding:2rem;
                    ...
                    <p style="font-size:0.9rem;opacity:0.8;">
                        Downloading ~500 MB — this may take several minutes
                    </p>
                </div>
            </model-viewer>
            <style>
        ...
        modelViewer.addEventListener('error', (event) => {
            ...
            showError('Failed to load the 3D model. The file may be missing or too large for your browser.');
        });
    }
    ...
    function showError(message) {
        ...
        container.innerHTML = `
            <div style="display:flex;align-items:center;justify-content:center;
                        height:700px;background:#f8d7da;color:#721c24;
                ...
                <button onclick="document.getElementById('view-screenshot-btn').click()"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Toggle on tap for touch devices (hover handles desktop via CSS)
